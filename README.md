...
Create a configuration file `$XDG_CONFIG_HOME/fish-ai.ini` (use `~/.config/fish-ai.ini` if `$XDG_CONFIG_HOME` is
not set) where you specify which LLM `fish-ai` should talk to. If you're not sure, use GitHub Models.
